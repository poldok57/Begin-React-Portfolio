...
export const MemorySection = () => {
  return (
    <SectionWrapper title="Are U boring ? Let's play !">
      <MemoryProvider>
        <div className="relative flex h-fit w-full flex-col gap-4 border-dashed border-gray-800">
          <MemoryBoardWP
            className="flex w-fit flex-col items-center gap-2 rounded-md border-2 border-secondary bg-background p-2 shadow-lg lg:absolute lg:left-1"
